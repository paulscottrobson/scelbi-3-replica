...
case 0x40: /* 40 jnc @2 */
    if (cpuPhase == 3) { if (Carry == 0) { PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x42: /* 42 cnc @2 */
    if (cpuPhase == 3) { if (Carry == 0) { PUSH();PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x44: /* 44 jmp @2 */
    if (cpuPhase == 3) { PCTR = temp16;STATUS(0);DISPLAY(temp16,MB);CYCLES(11);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x46: /* 46 call @2 */
    if (cpuPhase == 3) { PUSH();PCTR = temp16;STATUS(0);DISPLAY(temp16,MB);CYCLES(11);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x48: /* 48 jnz @2 */
    if (cpuPhase == 3) { if (PSZValue != 0) { PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x4a: /* 4a cnz @2 */
    if (cpuPhase == 3) { if (PSZValue != 0) { PUSH();PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x50: /* 50 jp @2 */
    if (cpuPhase == 3) { if ((PSZValue & 0x80) == 0) { PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x52: /* 52 cp @2 */
    if (cpuPhase == 3) { if ((PSZValue & 0x80) == 0) { PUSH();PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x58: /* 58 jpo @2 */
    if (cpuPhase == 3) { if (_CPUParityEven(PSZValue) == 0) { PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
...
case 0x5a: /* 5a cpo @2 */
    if (cpuPhase == 3) { if (_CPUParityEven(PSZValue) == 0) { PUSH();PCTR = temp16; };STATUS(0);DISPLAY(PCTR,MB);CYCLES(10);cpuPhase = (0); }
    if (cpuPhase == 2) { temp16 = MB;FETCH();temp16 = ((((WORD16)MB) << 8)|temp16) & 0x3FFF;;STATUS(2);DISPLAY(PCTR,MB);cpuPhase = 3; }
    if (cpuPhase == 1) { FETCH();STATUS(2);DISPLAY(PCTR,opcode);cpuPhase = 2; }
    break;
